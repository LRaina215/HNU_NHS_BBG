...
static const _BoundingBox2D_type_support_symbol_names_t _BoundingBox2D_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bboxes_ex_msgs, msg, BoundingBox2D)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bboxes_ex_msgs, msg, BoundingBox2D)),
  }
};
...
get_message_type_support_handle<bboxes_ex_msgs::msg::BoundingBox2D>()
{
  return &::bboxes_ex_msgs::msg::rosidl_typesupport_cpp::BoundingBox2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bboxes_ex_msgs, msg, BoundingBox2D)() {
  return get_message_type_support_handle<bboxes_ex_msgs::msg::BoundingBox2D>();
}
