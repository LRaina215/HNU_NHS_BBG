...
static const _ObjectCount_type_support_symbol_names_t _ObjectCount_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bboxes_ex_msgs, msg, ObjectCount)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bboxes_ex_msgs, msg, ObjectCount)),
  }
};
...
{
  return &::bboxes_ex_msgs::msg::rosidl_typesupport_cpp::ObjectCount_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, bboxes_ex_msgs, msg, ObjectCount)() {
  return get_message_type_support_handle<bboxes_ex_msgs::msg::ObjectCount>();
}
