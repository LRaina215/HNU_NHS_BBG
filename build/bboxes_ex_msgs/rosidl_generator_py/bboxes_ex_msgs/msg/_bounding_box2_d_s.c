...
bool bboxes_ex_msgs__msg__bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bboxes_ex_msgs.msg._bounding_box2_d.BoundingBox2D", full_classname_dest, 49) == 0);
  }
  bboxes_ex_msgs__msg__BoundingBox2D * ros_message = _ros_message;
  {  // probability
...
PyObject * bboxes_ex_msgs__msg__bounding_box2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bboxes_ex_msgs.msg._bounding_box2_d");
