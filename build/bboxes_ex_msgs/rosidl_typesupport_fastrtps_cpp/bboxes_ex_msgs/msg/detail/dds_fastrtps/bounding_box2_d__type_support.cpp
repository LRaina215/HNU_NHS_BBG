...
#include "bboxes_ex_msgs/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const bboxes_ex_msgs::msg::BoundingBox2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bboxes_ex_msgs::msg::BoundingBox2D *>(
    untyped_ros_message);
...
{
  return &bboxes_ex_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2D__handle;
}
