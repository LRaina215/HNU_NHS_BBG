...
#include "bboxes_ex_msgs/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox2D__ros_msg_type = bboxes_ex_msgs__msg__BoundingBox2D;
...
static uint32_t _BoundingBox2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bboxes_ex_msgs__msg__BoundingBox2D(
...
{
  return max_serialized_size_bboxes_ex_msgs__msg__BoundingBox2D(
    full_bounded, 0);
}
