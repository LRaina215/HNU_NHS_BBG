...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__init(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(msg);
    return false;
  }
  // image_header
  ...
  // bounding_boxes
  if (!bboxes_ex_msgs__msg__BoundingPolygonBox2D__Sequence__init(&msg->bounding_boxes, 0)) {
    bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(msg);
    return false;
  }
  return true;
...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * msg)
{
  ...
  // bounding_boxes
  bboxes_ex_msgs__msg__BoundingPolygonBox2D__Sequence__fini(&msg->bounding_boxes);
}
...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__are_equal(const bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * lhs, const bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * rhs)
{
  ...
  // bounding_boxes
  if (!bboxes_ex_msgs__msg__BoundingPolygonBox2D__Sequence__are_equal(
  ...
  bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * output)
{
  ...
  // bounding_boxes
  if (!bboxes_ex_msgs__msg__BoundingPolygonBox2D__Sequence__copy(
...
{
  bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * msg = (bboxes_ex_msgs__msg__BoundingPolygonBoxes2D *)malloc(sizeof(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D));
  bool success = bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence__init(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * array, size_t size)
{
  ...
  bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * data = NULL;
  if (size) {
    data = (bboxes_ex_msgs__msg__BoundingPolygonBoxes2D *)calloc(size, sizeof(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence__fini(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * array = (bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence *)malloc(sizeof(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence__fini(array);
  }
  free(array);
}
...
bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence__are_equal(const bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * lhs, const bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bboxes_ex_msgs__msg__BoundingPolygonBoxes2D);
    bboxes_ex_msgs__msg__BoundingPolygonBoxes2D * data =
      (bboxes_ex_msgs__msg__BoundingPolygonBoxes2D *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bboxes_ex_msgs__msg__BoundingPolygonBoxes2D__copy(
