...
{
  new (message_memory) bboxes_ex_msgs::msg::ObjectCount(_init);
}

void ObjectCount_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bboxes_ex_msgs::msg::ObjectCount *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectCount_message_member_array[2] = {
  {
    ...
    offsetof(bboxes_ex_msgs::msg::ObjectCount, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bboxes_ex_msgs::msg::ObjectCount, count),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectCount_message_members = {
  ...
  2,  // number of fields
  sizeof(bboxes_ex_msgs::msg::ObjectCount),
...
get_message_type_support_handle<bboxes_ex_msgs::msg::ObjectCount>()
{
  return &::bboxes_ex_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectCount_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bboxes_ex_msgs, msg, ObjectCount)() {
  return &::bboxes_ex_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectCount_message_type_support_handle;
}
