...
bool game_msgs__msg__robot_hp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("game_msgs.msg._robot_hp.RobotHP", full_classname_dest, 31) == 0);
  }
  game_msgs__msg__RobotHP * ros_message = _ros_message;
  {  // red_1_robot_hp
...
PyObject * game_msgs__msg__robot_hp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("game_msgs.msg._robot_hp");
