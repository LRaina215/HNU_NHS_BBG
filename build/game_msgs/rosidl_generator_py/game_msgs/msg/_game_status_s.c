...
bool game_msgs__msg__game_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("game_msgs.msg._game_status.GameStatus", full_classname_dest, 37) == 0);
  }
  game_msgs__msg__GameStatus * ros_message = _ros_message;
  {  // game_type
    ...
    ros_message->game_type = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // game_progress
    ...
    assert(PyLong_Check(field));
    ros_message->game_progress = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // stage_remain_time
...
PyObject * game_msgs__msg__game_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("game_msgs.msg._game_status");
