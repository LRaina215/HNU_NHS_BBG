...
bool game_msgs__msg__zone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("game_msgs.msg._zone.Zone", full_classname_dest, 24) == 0);
  }
  game_msgs__msg__Zone * ros_message = _ros_message;
  {  // f1_zone_status
    ...
    ros_message->f1_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f1_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f1_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f2_zone_status
    ...
    assert(PyLong_Check(field));
    ros_message->f2_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f2_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f2_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f3_zone_status
    ...
    assert(PyLong_Check(field));
    ros_message->f3_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f3_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f3_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f4_zone_status
    ...
    assert(PyLong_Check(field));
    ros_message->f4_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f4_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f4_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f5_zone_status
    ...
    assert(PyLong_Check(field));
    ros_message->f5_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f5_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f5_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f6_zone_status
    ...
    assert(PyLong_Check(field));
    ros_message->f6_zone_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // f6_zone_buff_debuff_status
    ...
    assert(PyLong_Check(field));
    ros_message->f6_zone_buff_debuff_status = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // red1_bullet_left
    ...
    assert(PyLong_Check(field));
    ros_message->red1_bullet_left = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // red2_bullet_left
    ...
    assert(PyLong_Check(field));
    ros_message->red2_bullet_left = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // blue1_bullet_left
    ...
    assert(PyLong_Check(field));
    ros_message->blue1_bullet_left = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // blue2_bullet_left
    ...
    assert(PyLong_Check(field));
    ros_message->blue2_bullet_left = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * game_msgs__msg__zone__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("game_msgs.msg._zone");
  ...
  {  // f1_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f1_zone_status);
    {
  ...
  {  // f1_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f1_zone_buff_debuff_status);
    {
  ...
  {  // f2_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f2_zone_status);
    {
  ...
  {  // f2_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f2_zone_buff_debuff_status);
    {
  ...
  {  // f3_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f3_zone_status);
    {
  ...
  {  // f3_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f3_zone_buff_debuff_status);
    {
  ...
  {  // f4_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f4_zone_status);
    {
  ...
  {  // f4_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f4_zone_buff_debuff_status);
    {
  ...
  {  // f5_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f5_zone_status);
    {
  ...
  {  // f5_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f5_zone_buff_debuff_status);
    {
  ...
  {  // f6_zone_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f6_zone_status);
    {
  ...
  {  // f6_zone_buff_debuff_status
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->f6_zone_buff_debuff_status);
    {
  ...
  {  // red1_bullet_left
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->red1_bullet_left);
    {
  ...
  {  // red2_bullet_left
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->red2_bullet_left);
    {
  ...
  {  // blue1_bullet_left
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->blue1_bullet_left);
    {
  ...
  {  // blue2_bullet_left
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->blue2_bullet_left);
    {
