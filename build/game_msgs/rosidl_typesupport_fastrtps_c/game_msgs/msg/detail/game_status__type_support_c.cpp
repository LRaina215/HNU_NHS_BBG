...
#include "game_msgs/msg/detail/game_status__rosidl_typesupport_fastrtps_c.h"
...
using _GameStatus__ros_msg_type = game_msgs__msg__GameStatus;
...
size_t get_serialized_size_game_msgs__msg__GameStatus(
  const void * untyped_ros_message,
...
static uint32_t _GameStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_game_msgs__msg__GameStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_game_msgs
size_t max_serialized_size_game_msgs__msg__GameStatus(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_game_msgs__msg__GameStatus(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, game_msgs, msg, GameStatus)() {
