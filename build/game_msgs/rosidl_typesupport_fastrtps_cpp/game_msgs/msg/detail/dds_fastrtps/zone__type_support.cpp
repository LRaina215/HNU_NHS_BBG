...
#include "game_msgs/msg/detail/zone__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const game_msgs::msg::Zone *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<game_msgs::msg::Zone *>(
    untyped_ros_message);
...
{
  return &game_msgs::msg::typesupport_fastrtps_cpp::_Zone__handle;
}
