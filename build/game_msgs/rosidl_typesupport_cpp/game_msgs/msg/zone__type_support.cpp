...
static const _Zone_type_support_symbol_names_t _Zone_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, game_msgs, msg, Zone)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, game_msgs, msg, Zone)),
  }
};
...
get_message_type_support_handle<game_msgs::msg::Zone>()
{
  return &::game_msgs::msg::rosidl_typesupport_cpp::Zone_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, game_msgs, msg, Zone)() {
  return get_message_type_support_handle<game_msgs::msg::Zone>();
}
