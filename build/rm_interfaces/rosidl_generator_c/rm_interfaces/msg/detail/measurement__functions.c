...
{
  rm_interfaces__msg__Measurement * msg = (rm_interfaces__msg__Measurement *)malloc(sizeof(rm_interfaces__msg__Measurement));
  if (!msg) {
    return NULL;
  }
...
rm_interfaces__msg__Measurement__Sequence__init(rm_interfaces__msg__Measurement__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rm_interfaces__msg__Measurement *)calloc(size, sizeof(rm_interfaces__msg__Measurement));
    if (!data) {
      return false;
    }
...
{
  rm_interfaces__msg__Measurement__Sequence * array = (rm_interfaces__msg__Measurement__Sequence *)malloc(sizeof(rm_interfaces__msg__Measurement__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  rm_interfaces__msg__Measurement__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rm_interfaces__msg__Measurement * data =
      (rm_interfaces__msg__Measurement *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__msg__Measurement__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rm_interfaces__msg__Measurement__fini(&data[i]);
        }
        free(data);
        return false;
      }
