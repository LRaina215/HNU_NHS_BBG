...
#include "rmctrl_msgs/msg/detail/gimbal__rosidl_typesupport_fastrtps_c.h"
...
using _Gimbal__ros_msg_type = rmctrl_msgs__msg__Gimbal;
...
static uint32_t _Gimbal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rmctrl_msgs__msg__Gimbal(
...
{
  return max_serialized_size_rmctrl_msgs__msg__Gimbal(
    full_bounded, 0);
}
