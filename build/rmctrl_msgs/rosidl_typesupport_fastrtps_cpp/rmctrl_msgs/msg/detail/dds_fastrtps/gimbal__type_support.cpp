...
#include "rmctrl_msgs/msg/detail/gimbal__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rmctrl_msgs::msg::Gimbal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rmctrl_msgs::msg::Gimbal *>(
    untyped_ros_message);
...
{
  return &rmctrl_msgs::msg::typesupport_fastrtps_cpp::_Gimbal__handle;
}
