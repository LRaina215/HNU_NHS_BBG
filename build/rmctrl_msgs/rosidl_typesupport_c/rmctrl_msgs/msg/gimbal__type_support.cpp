...
static const _Gimbal_type_support_symbol_names_t _Gimbal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rmctrl_msgs, msg, Gimbal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rmctrl_msgs, msg, Gimbal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rmctrl_msgs, msg, Gimbal)() {
  return &::rmctrl_msgs::msg::rosidl_typesupport_c::Gimbal_message_type_support_handle;
}
