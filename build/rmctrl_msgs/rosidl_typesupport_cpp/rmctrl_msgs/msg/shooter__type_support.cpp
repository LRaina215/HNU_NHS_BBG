...
static const _Shooter_type_support_symbol_names_t _Shooter_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rmctrl_msgs, msg, Shooter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rmctrl_msgs, msg, Shooter)),
  }
};
...
{
  return &::rmctrl_msgs::msg::rosidl_typesupport_cpp::Shooter_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rmctrl_msgs, msg, Shooter)() {
  return get_message_type_support_handle<rmctrl_msgs::msg::Shooter>();
}
