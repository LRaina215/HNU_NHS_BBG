...
{
  rm_interfaces__msg__RuneTarget * msg = (rm_interfaces__msg__RuneTarget *)malloc(sizeof(rm_interfaces__msg__RuneTarget));
  if (!msg) {
    return NULL;
  }
...
rm_interfaces__msg__RuneTarget__Sequence__init(rm_interfaces__msg__RuneTarget__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rm_interfaces__msg__RuneTarget *)calloc(size, sizeof(rm_interfaces__msg__RuneTarget));
    if (!data) {
      return false;
    }
...
{
  rm_interfaces__msg__RuneTarget__Sequence * array = (rm_interfaces__msg__RuneTarget__Sequence *)malloc(sizeof(rm_interfaces__msg__RuneTarget__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  rm_interfaces__msg__RuneTarget__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rm_interfaces__msg__RuneTarget * data =
      (rm_interfaces__msg__RuneTarget *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__msg__RuneTarget__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rm_interfaces__msg__RuneTarget__fini(&data[i]);
        }
        free(data);
        return false;
      }
