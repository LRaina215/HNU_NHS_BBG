...
{
  rm_interfaces__srv__SetMode_Request * msg = (rm_interfaces__srv__SetMode_Request *)malloc(sizeof(rm_interfaces__srv__SetMode_Request));
  if (!msg) {
    return NULL;
  }
...
rm_interfaces__srv__SetMode_Request__Sequence__init(rm_interfaces__srv__SetMode_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rm_interfaces__srv__SetMode_Request *)calloc(size, sizeof(rm_interfaces__srv__SetMode_Request));
    if (!data) {
      return false;
    }
...
{
  rm_interfaces__srv__SetMode_Request__Sequence * array = (rm_interfaces__srv__SetMode_Request__Sequence *)malloc(sizeof(rm_interfaces__srv__SetMode_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  rm_interfaces__srv__SetMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rm_interfaces__srv__SetMode_Request * data =
      (rm_interfaces__srv__SetMode_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__srv__SetMode_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rm_interfaces__srv__SetMode_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  rm_interfaces__srv__SetMode_Response * msg = (rm_interfaces__srv__SetMode_Response *)malloc(sizeof(rm_interfaces__srv__SetMode_Response));
  if (!msg) {
    return NULL;
  }
...
rm_interfaces__srv__SetMode_Response__Sequence__init(rm_interfaces__srv__SetMode_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (rm_interfaces__srv__SetMode_Response *)calloc(size, sizeof(rm_interfaces__srv__SetMode_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rm_interfaces__srv__SetMode_Response__Sequence * array = (rm_interfaces__srv__SetMode_Response__Sequence *)malloc(sizeof(rm_interfaces__srv__SetMode_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  rm_interfaces__srv__SetMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    rm_interfaces__srv__SetMode_Response * data =
      (rm_interfaces__srv__SetMode_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!rm_interfaces__srv__SetMode_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          rm_interfaces__srv__SetMode_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
