...
static rosidl_typesupport_introspection_c__MessageMember SetMode_Request__rosidl_typesupport_introspection_c__SetMode_Request_message_member_array[1] = {
  {
    "mode",  // name
...
static rosidl_typesupport_introspection_c__MessageMember SetMode_Response__rosidl_typesupport_introspection_c__SetMode_Response_message_member_array[2] = {
  {
    "success",  // name
