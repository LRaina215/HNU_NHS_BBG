...
#include <stddef.h>
#include "bboxes_ex_msgs/msg/detail/object_count__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  bboxes_ex_msgs__msg__ObjectCount__init(message_memory);
}

void ObjectCount__rosidl_typesupport_introspection_c__ObjectCount_fini_function(void * message_memory)
{
  bboxes_ex_msgs__msg__ObjectCount__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ObjectCount__rosidl_typesupport_introspection_c__ObjectCount_message_member_array[2] = {
  {
    ...
    offsetof(bboxes_ex_msgs__msg__ObjectCount, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bboxes_ex_msgs__msg__ObjectCount, count),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ObjectCount__rosidl_typesupport_introspection_c__ObjectCount_message_members = {
  ...
  2,  // number of fields
  sizeof(bboxes_ex_msgs__msg__ObjectCount),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bboxes_ex_msgs, msg, ObjectCount)() {
