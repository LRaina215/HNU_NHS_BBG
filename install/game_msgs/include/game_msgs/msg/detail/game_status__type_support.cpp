...
{
  new (message_memory) game_msgs::msg::GameStatus(_init);
}

void GameStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<game_msgs::msg::GameStatus *>(message_memory);
  typed_message->~GameStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember GameStatus_message_member_array[3] = {
  {
    "game_type",  // name
    ...
    offsetof(game_msgs::msg::GameStatus, game_type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(game_msgs::msg::GameStatus, game_progress),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(game_msgs::msg::GameStatus, stage_remain_time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GameStatus_message_members = {
  ...
  3,  // number of fields
  sizeof(game_msgs::msg::GameStatus),
...
{
  return &::game_msgs::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, game_msgs, msg, GameStatus)() {
  return &::game_msgs::msg::rosidl_typesupport_introspection_cpp::GameStatus_message_type_support_handle;
}
