...
class Metaclass_Zone(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('game_msgs')
        except ImportError:
            import logging
            import traceback
...
class Zone(metaclass=Metaclass_Zone):
    ...
    _fields_and_field_types = {
        'f1_zone_status': 'int8',
        'f1_zone_buff_debuff_status': 'int8',
        'f2_zone_status': 'int8',
        'f2_zone_buff_debuff_status': 'int8',
        'f3_zone_status': 'int8',
        'f3_zone_buff_debuff_status': 'int8',
        'f4_zone_status': 'int8',
        'f4_zone_buff_debuff_status': 'int8',
        'f5_zone_status': 'int8',
        'f5_zone_buff_debuff_status': 'int8',
        'f6_zone_status': 'int8',
        'f6_zone_buff_debuff_status': 'int8',
        'red1_bullet_left': 'int8',
        'red2_bullet_left': 'int8',
        'blue1_bullet_left': 'int8',
        'blue2_bullet_left': 'int8',
    }
    ...
    def f1_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f1_zone_status' field must be an integer in [-128, 127]"
    ...
    def f1_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f1_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def f2_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f2_zone_status' field must be an integer in [-128, 127]"
    ...
    def f2_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f2_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def f3_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f3_zone_status' field must be an integer in [-128, 127]"
    ...
    def f3_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f3_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def f4_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f4_zone_status' field must be an integer in [-128, 127]"
    ...
    def f4_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f4_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def f5_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f5_zone_status' field must be an integer in [-128, 127]"
    ...
    def f5_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f5_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def f6_zone_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f6_zone_status' field must be an integer in [-128, 127]"
    ...
    def f6_zone_buff_debuff_status(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'f6_zone_buff_debuff_status' field must be an integer in [-128, 127]"
    ...
    def red1_bullet_left(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'red1_bullet_left' field must be an integer in [-128, 127]"
    ...
    def red2_bullet_left(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'red2_bullet_left' field must be an integer in [-128, 127]"
    ...
    def blue1_bullet_left(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'blue1_bullet_left' field must be an integer in [-128, 127]"
    ...
    def blue2_bullet_left(self, value):
        if __debug__:
            ...
            assert value >= -128 and value < 128, \
                "The 'blue2_bullet_left' field must be an integer in [-128, 127]"
